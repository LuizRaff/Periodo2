...
int main (int argc, char **argv) {
  ...
  double tstop = clock();
  double total_criacao_sec_t = tstop - tstart; // COMPLETAR: adicionar medicao de tempo para criacao das arvores
  printf("Tempo em segundos para criar arvores: %2.2f\n", total_criacao_sec_t);
  ...
  tstop = clock();
  double total_busca_a1 = tstop - tstart; // COMPLETAR: adicionar medicao de tempo para buscas
  printf("Tempo: %2.2lf segundos\n", total_busca_a1);
  tstart = clock();
  ...
  tstop = clock();
  double total_busca_a2 = tstop - tstart; // COMPLETAR: adicionar medicao de tempo para buscas
  printf("Tempo: %2.2lf segundos\n", total_busca_a2);
  ...
  tstop = clock();
  double total_busca_a1_2 = tstop - tstart; // COMPLETAR: adicionar medicao de tempo para buscas
  printf("Tempo: %2.2lf segundos\n", total_busca_a1_2);
